...
interface PokedexService {
    ...
    suspend fun getPokemonDetail(@Path("pokemonName") pokemonName: String): PokemonInfo

    @GET("pokemon/{pokemonNumber}/encounters")
    suspend fun getPokemonLocation(@Path("pokemonNumber") pokemonNumber: Int): Array<PokemonLocations>

    @GET("evolution-chain/{pokemonNumber}/")
    suspend fun getPokemonEvolutions(@Path("pokemonNumber") pokemonNumber: Int): PokemonEvolution
}